...
- Commits must be authored as `bru <bru@users.noreply.github.com>`.
- Do not add AI model attribution trailers (`Co-authored-by:`, etc.) or external conversational comparisons.
